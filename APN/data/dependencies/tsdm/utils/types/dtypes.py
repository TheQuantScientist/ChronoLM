...
if hasattr(np, "float128"):
    NUMPY_FLOAT_TYPECODES[np.float128] = "g"
...
if hasattr(np, "complex256"):
    NUMPY_COMPLEX_TYPECODES[np.complex256] = "G"
...
NUMPY_FLOAT_TYPESTRINGS: Final[dict[type[np.floating], str]] = {
    ...
    np.single: "float32",
    np.double: "float64",
    np.longdouble: np.dtype(np.longdouble).name,
}
if hasattr(np, "float128"):
    NUMPY_FLOAT_TYPESTRINGS[np.float128] = "float128"
...
NUMPY_COMPLEX_TYPESTRINGS: Final[dict[type[np.complexfloating], str]] = {
    ...
    np.clongdouble: np.dtype(np.clongdouble).name,
}
if hasattr(np, "complex256"):
    NUMPY_COMPLEX_TYPESTRINGS[np.complex256] = "complex256"
...
if hasattr(np, "float128"):
    NUMPY_DTYPES["float128"] = np.float128
if hasattr(np, "complex256"):
    NUMPY_DTYPES["complex256"] = np.complex256
