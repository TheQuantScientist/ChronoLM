"""Repository-root entry point for the OpenAI GPT-5 mini USHCN experiment."""
...
os.environ.setdefault("CHRONOLM_DATASET", "USHCN")
...
os.environ.setdefault("CHRONOLM_RUN_NAME", "gpt5_mini_ushcn_anchor_blend_mse")
os.environ.setdefault("CHRONOLM_PROMPT_STYLE", "gpt_climate_anchor_blend_mse")
os.environ.setdefault("CHRONOLM_ANCHOR_BLEND_WEIGHT", "0.90")
...
if "CHRONOLM_API_KEY" not in os.environ:
    ...
    if not openai_api_key:
        raise RuntimeError(
            "Set OPENAI_API_KEY before running run_ushcn_gpt5_mini.py. "
